            ...
            <g key={`points-group-${i}`}>
              <g key={`start-${i}`}>
                ...
                {showLabels && dot.start.label && (
                  ...
                  >
                    <foreignObject x={startPoint.x - 60} y={startPoint.y - 30} width="120" height="25">
                      <div className="flex items-center justify-center h-full">
                        <span className="text-[10px] font-medium px-2 py-0.5 rounded-md bg-white/90 dark:bg-black/90 text-black dark:text-white border border-gray-200 dark:border-gray-700 shadow-sm whitespace-nowrap">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
              ...
              <g key={`end-${i}`}>
                ...
                {showLabels && dot.end.label && (
                  <motion.g
                    ...
                    className="pointer-events-none"
                  >
                    <foreignObject x={endPoint.x - 60} y={endPoint.y - 30} width="120" height="25">
                      <div className="flex items-center justify-center h-full">
                        <span className="text-[10px] font-medium px-2 py-0.5 rounded-md bg-white/90 dark:bg-black/90 text-black dark:text-white border border-gray-200 dark:border-gray-700 shadow-sm whitespace-nowrap">
                          {dot.end.label}
                        </span>
