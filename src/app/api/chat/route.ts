  ...
  switch (name) {
    ...
    case "get_career_timeline":
      return [
        ...
        { period: "2020", role: "Consultant", company: "Freenome", details: "AI genomics startup on the mission of early cancer detection ($238M Series B). Technical recruiting supporting the ML Platform team: sourced and screened ML infrastructure and platform engineers, partnered with hiring managers on role scoping and close. Engagement paused when COVID reshuffled hiring priorities." },
